...
wine_v4_X500 <- wine_v3 %>% filter(X<=500)

lat_lon_dfinput <- wine_v4_X500 %>% mutate(id=X) %>% select(id, latitude, longitude)
...
wine_v5_X500 <- wine_v4_X500 %>% 
  mutate(stationid = as.character(stationids[,1])) %>%
  select(X, stationid)

save(wine_v5_X500, file="wine_v5_X500.RData")
```
