...
Data visualizations include average ratings by type of wine (using boxplots), average ratings by country (using maps), average ratings by country and year (using the tile plots in R), and average ratings by type of wine and year (using the tile plots in R). *****when we have weather data, can also add in correlation plots between prec./temp and rating
